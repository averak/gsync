...
public class PlayerDto extends AbstractDto<PlayerDto> implements Serializable {
	/**
	 *
	 ...
	 * @mbg.generated
	 */
	public PlayerDto(@Nonnull String playerId, @Nonnull Boolean isBanned, @Nonnull LocalDateTime createdAt,
	 ...
	 * @mbg.generated
	 */
	public PlayerDto(@Nonnull String playerId, @Nonnull Boolean isBanned) {
		this.playerId = playerId;
		this.isBanned = isBanned;
